...
public class Expense implements Controller{
    @Override
    public void add(String inputAmount, String inputType, FileWriter fileWriter) {

        Element_of_record element = new Exp(inputAmount, inputType);
        ...
        try {
            ...
            while ((line = fileReader.readLine()) != null) {
                ...
                try {
                    ...
                    Exp expense = mapper.readValue(line, Exp.class);
                    expense.show();
                } catch (JsonProcessingException e) {
                    throw new RuntimeException("", e);
                }
    ...
    public static void outcome(BufferedReader fileReader) {
        try {
            ...
            while ((line = fileReader.readLine()) != null) {
                ...
                try {
                    Exp expense = mapper.readValue(line, Exp.class);
                    result += Integer.parseInt(expense.getAmount());
                } catch (JsonProcessingException e) {
                    throw new RuntimeException("", e);
                }
            }
